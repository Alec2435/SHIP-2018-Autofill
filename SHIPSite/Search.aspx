<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Search.aspx.cs" Inherits="SHIPAutofill.WebForm4"  MasterPageFile="~/Site.Master"%>
...
<asp:Content ID="MainContent" runat="server" contentplaceholderid="MainContent">
    ...
    ​<div style="width: 100%; height: 750px; overflow:auto; position: relative; top: 10%; text-align: center; left: -7px; overflow-x:hidden" id="centerDiv">
        ...
        ItemType="SHIPAutofill.Row" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="4" ForeColor="Black" OnRowDataBound="GridView1_RowDataBound" AutoGenerateColumns="False" Height="101px">
            <Columns>
